...
import 'package:flutter_new_project/api/movies_list_screen.dart';
...
import 'package:flutter_new_project/provider_screens/shopping_items_screen.dart';
            ...
            DrawerItemWidget(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ShoppingItemsScreen(),
                  ),
                );
              },
            ),
